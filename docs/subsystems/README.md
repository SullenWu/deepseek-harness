...
| [customer-service-database.md](customer-service-database.md) | request-local reviewed-schema discovery, server-owned identity scope, structured SQL compilation, and read-only MySQL execution |
