...
export const en = {
  ...
  settingsUnavailable: 'These provider settings namespaces failed to load: {namespaces}. Fix their configuration and restart DeepSeek Harness.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  settingsUnavailable: '以下提供方设置分区加载失败：{namespaces}。请修正配置并重启 DeepSeek Harness。',
